...
import { Flower2, Sparkles, Code, Briefcase, Activity, Database, LineChart, Network, Sliders, Shield, Lightbulb, Circle, Triangle, Hexagon, Square } from 'lucide-react';
        ...
        <div className="portfolio-grid">
          ...
          <div className="glass-card card-about" id="about" style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
            <div style={{ flex: 1 }}>
              ...
              <button className="hero-btn" style={{ fontSize: '0.8rem' }} onClick={() => window.open('/Shivansh_Sharma_Resume.pdf', '_blank')}>
                Resume / Download CV 
          ...
          <div className="glass-card card-stats interactive-card">
            ...
            <div className="stat-box">
              <CuriosityIcon />
              <span className="stat-num counter" style={{ fontSize: '2.5rem', marginTop: '-0.6rem', marginBottom: '-0.2rem', lineHeight: '1' }}>∞</span>
